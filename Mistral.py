...
expert_configs = {
    "alpaca": {
        "adapter_weights": "/kaggle/input/worksapce/worksapce/orkspace/Falcon-RW-1B-Alpaca/results/alpaca_adapter/adapter_model.safetensors",
        "gamma": "/kaggle/input/worksapce/worksapce/orkspace/Falcon-RW-1B-Alpaca/results/alpaca_adapter/adapter_config.json",
        "base_weights": "/kaggle/input/worksapce/worksapce/orkspace/Falcon-RW-1B-Alpaca/base_model_weights.pth",
    ...
    "beavertails": {
        "adapter_weights": "/kaggle/input/worksapce/worksapce/orkspace/Falcon-RW-1B-BeaverTails/results/beavertails_adapter/adapter_model.safetensors",
        "gamma": "/kaggle/input/worksapce/worksapce/orkspace/Falcon-RW-1B-BeaverTails/results/beavertails_adapter/adapter_config.json",
        "base_weights": "/kaggle/input/worksapce/worksapce/orkspace/Falcon-RW-1B-BeaverTails/base_model_weights.pth",
    ...
    "truthfulqa": {
        "adapter_weights": "/kaggle/input/worksapce/worksapce/orkspace/Falcon-RW-1B-TruthfulQA/results/truthfulqa_adapter/adapter_model.safetensors",
        "gamma": "/kaggle/input/worksapce/worksapce/orkspace/Falcon-RW-1B-TruthfulQA/results/truthfulqa_adapter/adapter_config.json",
        "base_weights": "/kaggle/input/worksapce/worksapce/orkspace/Falcon-RW-1B-TruthfulQA/base_model_weights.pth",
