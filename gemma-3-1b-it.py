...
expert_configs = {
    "alpaca": {
        "adapter_weights": "/kaggle/input/worksapce/worksapce/orkspace/gemma-3-1b-it-Alpaca/results/alpaca_adapter/adapter_model.safetensors",
        "gamma": "/kaggle/input/worksapce/worksapce/orkspace/gemma-3-1b-it-Alpaca/results/alpaca_adapter/adapter_config.json",
        "base_weights": "/kaggle/input/worksapce/worksapce/orkspace/gemma-3-1b-it-Alpaca/base_model_weights.pth",
    ...
    "beavertails": {
        "adapter_weights": "/kaggle/input/worksapce/worksapce/orkspace/gemma-3-1b-it-BeaverTails/results/beavertails_adapter/adapter_model.safetensors",
        "gamma": "/kaggle/input/worksapce/worksapce/orkspace/gemma-3-1b-it-BeaverTails/results/beavertails_adapter/adapter_config.json",
        "base_weights": "/kaggle/input/worksapce/worksapce/orkspace/gemma-3-1b-it-BeaverTails/base_model_weights.pth",
    ...
    "truthfulqa": {
        "adapter_weights": "/kaggle/input/worksapce/worksapce/orkspace/gemma-3-1b-it-TruthfulQA/results/truthfulqa_adapter/adapter_model.safetensors",
        "gamma": "/kaggle/input/worksapce/worksapce/orkspace/gemma-3-1b-it-TruthfulQA/results/truthfulqa_adapter/adapter_config.json",
        "base_weights": "/kaggle/input/worksapce/worksapce/orkspace/gemma-3-1b-it-TruthfulQA/base_model_weights.pth",
