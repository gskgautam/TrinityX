...
Original file is located at
    https://colab.research.google.com/drive/1Q_u77FiGkyK0b-a0O3S03Jl1q1mmyQJl
    ...
    for k in adapter_state_dict.keys():
        if k in base_state_dict:
            ...
            if norm_diff > 0:
                ...
                print(f"⚠️ Layer '{k}' has no difference (Norm: {norm_diff:.6f}) - Check if training updated parameters!")
        else:
